...
CHAR_SPLITTER_PATH = "src.domain.strategies.length_based_chunking.CharacterTextSplitter"
TOKEN_SPLITTER_PATH = "src.domain.strategies.length_based_chunking.TokenTextSplitter"
CHUNK_MODEL_PATH = "src.domain.strategies.length_based_chunking.Chunk"
LANGCHAIN_DOC_PATH = "src.domain.strategies.length_based_chunking.LangchainDocument"
